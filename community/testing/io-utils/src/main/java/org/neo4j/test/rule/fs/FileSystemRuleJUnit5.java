...
public abstract class FileSystemRuleJUnit5<FS extends FileSystemAbstraction>
        implements FileSystemAbstraction, Supplier<FileSystemAbstraction>, AfterEachCallback
{
    protected volatile FS fs;

    protected FileSystemRuleJUnit5( FS fs )
    {
        this.fs = fs;
    }
