...
public class Neo4jWithSocketJUnit5 implements BeforeEachCallback, AfterEachCallback
{
    ...
    public Neo4jWithSocketJUnit5( Class<?> testClass )
    {
    ...
    public Neo4jWithSocketJUnit5( Class<?> testClass, Consumer<Map<Setting<?>,Object>> configure )
    {
        this( testClass, new TestDatabaseManagementServiceBuilder(), configure );
    }

    public Neo4jWithSocketJUnit5( Class<?> testClass, TestDatabaseManagementServiceBuilder graphDatabaseFactory,
    ...
    public void beforeEach( ExtensionContext context ) throws IOException
    {
        ...
        {
            name = context.getRequiredTestMethod().getName();
        }
        else
            {
            name = context.getRequiredTestClass().getName();
        }
